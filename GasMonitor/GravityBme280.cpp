...
*/
void GravityBme280::write8(byte reg, byte value)
{
    if (cs == -1) {
...
*/
uint8_t GravityBme280::read8(byte reg)
{
    uint8_t value;
...
*/
uint16_t GravityBme280::read16(byte reg)
{
    uint16_t value;
...
uint16_t GravityBme280::read16_LE(byte reg)
{
...
*/
int16_t GravityBme280::readS16(byte reg)
{
    return (int16_t)read16(reg);
}


int16_t GravityBme280::readS16_LE(byte reg)
{
...
uint32_t GravityBme280::read24(byte reg)
{
    uint32_t value;
...
*/
void GravityBme280::takeForcedMeasurement()
{
...
*/
void GravityBme280::readCoefficients(void)
{
...
*/
bool GravityBme280::isReadingCalibration(void)
{
...
*/
float GravityBme280::temperatureValue(void)
{
    int32_t var1, var2;
...
*    @brief  Returns the temperature from the sensor
*/
float GravityBme280::pressureValue(void)
{
    int64_t var1, var2, p;
...
*/
float GravityBme280::humidityValue(void)
{
    temperatureValue(); // must be done first to get t_fine
...
*/
float GravityBme280::altitudeValue(float seaLevel)
{
...
*    @param  atmospheric   Atmospheric pressure in hPa
*/
float GravityBme280::seaLevelForAltitude(float altitude, float atmospheric)
{
    return atmospheric / pow(1.0 - (altitude/44330.0), 5.255);
}

void GravityBme280::update()
{
	tempe = temperatureValue();
	hu = humidityValue();
	pa = pressureValue();
}
//调用有参数的getValue
void GravityBme280::getValue(double dataValue[])
{
	dataValue[0] = tempe;
	dataValue[1] = hu;
	dataValue[2] = pa;
    //  dataValue[0] =temperatureValue();
